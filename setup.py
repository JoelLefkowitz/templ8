...
class UpdateDocs(Command):
    ...
    def run(self) -> None:
        subprocess.run(["sphinx-apidoc", "-o", "docs/", "templ8/", "tests/"])
...
s = setup(
    ...
    install_requires=['jinja2>=2.11.1', 'ruamel.yaml>=0.16.10', 'docopt>=0.6.1', 'emoji>=0.5.4', 'dataclasses>=0.7', 'pyimport>=0.3.0'],
