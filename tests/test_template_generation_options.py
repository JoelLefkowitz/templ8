...
@scenario(
    "tests/template_generation_options.feature", "Dont generate files for a dry run"
)
...
@scenario(
    "tests/template_generation_options.feature", "Dont run callbacks when deactivated"
)
...
@scenario(
    "tests/template_generation_options.feature", "Skip callbacks when files skipped"
)
